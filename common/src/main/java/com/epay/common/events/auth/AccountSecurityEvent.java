...
/**
 * Published for any sensitive account change:
 * password change, 2FA toggle, account locked, suspicious activity detected.
 *
 * Consumed by:
 *  - NotificationModule → sends account security alert email/SMS
 *  - HistoryModule      → writes security audit entry
 */
@Getter
