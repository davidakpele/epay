pipeline {
    agent any
    parameters {
        string(name: 'REPO_NAME', defaultValue: 'beneficiary-service', description: 'Name of the repository')
        string(name: 'DOCKER_IMAGE', defaultValue: 'xxxxxx/beneficiary-service:latest', description: 'Docker image name')
    }
    environment {
