pipeline {
    agent any
    parameters {
        string(name: 'REPO_NAME', defaultValue: 'blacklist-service', description: 'Name of the repository')
        string(name: 'DOCKER_IMAGE', defaultValue: 'xxxxxx/blacklist-service:latest', description: 'Docker image name')
    }
    environment {
