...
public class SettingController {
    ...
    private final UserAccountCasesReportService userAccountCasesReportService;

    public SettingController(UserService userServices, UserRecordService userRecordService, TwoFactorAuthenticationService twoFactorAuthenticationService, UserAccountCasesReportService userAccountCasesReportService) {
