...
|----------|-------------|--------|---------|---------------|--------|
| /api/wallet/ | SQLi: union select 1,2,3 | 403 | ✅ | 33ms | 🛡️ Blocked - Forbidden (W... |
...
| /api/wallet/ | SQLi: drop table users | 403 | ✅ | 12ms | 🛡️ Blocked - Forbidden (W... |
| /api/wallet/ | SQLi: exec sp_configure | 403 | ✅ | 10ms | 🛡️ Blocked - Forbidden (W... |
| /api/wallet/ | SQLi: 1' OR '1'='1 | 403 | ✅ | 52ms | 🛡️ Blocked - Forbidden (W... |
...
| /api/deposit/ | SQLi: union select 1,2,3 | 404 | ✅ | 450ms | 🛡️ Blocked - Resource not... |
| /api/deposit/ | SQLi: insert into users values('admin','password') | 404 | ✅ | 83ms | 🛡️ Blocked - Resource not... |
| /api/deposit/ | SQLi: delete from users where 1=1 | 404 | ✅ | 28ms | 🛡️ Blocked - Resource not... |
| /api/deposit/ | SQLi: drop table users | 404 | ✅ | 41ms | 🛡️ Blocked - Resource not... |
| /api/deposit/ | SQLi: exec sp_configure | 404 | ✅ | 32ms | 🛡️ Blocked - Resource not... |
| /api/deposit/ | SQLi: 1' OR '1'='1 | 404 | ✅ | 25ms | 🛡️ Blocked - Resource not... |
| /api/deposit/ | SQLi: admin'-- | 404 | ✅ | 52ms | 🛡️ Blocked - Resource not... |
| /api/deposit/ | SQLi: 1' UNION SELECT NULL,NULL-- | 404 | ✅ | 181ms | 🛡️ Blocked - Resource not... |
| /api/withdrawals/ | SQLi: union select 1,2,3 | 403 | ✅ | 13ms | 🛡️ Blocked - Forbidden (W... |
...
| /api/withdrawals/ | SQLi: drop table users | 401 | ✅ | 121ms | 🛡️ Blocked - Authenticati... |
| /api/withdrawals/ | SQLi: exec sp_configure | 429 | ✅ | 10ms | ⏱️ Rate Limited - Too many... |
| /api/withdrawals/ | SQLi: 1' OR '1'='1 | 401 | ✅ | 25ms | 🛡️ Blocked - Authenticati... |
| /api/withdrawals/ | SQLi: admin'-- | 429 | ✅ | 9ms | ⏱️ Rate Limited - Too many... |
| /api/withdrawals/ | SQLi: 1' UNION SELECT NULL,NULL-- | 403 | ✅ | 9ms | 🛡️ Blocked - Forbidden (W... |
...
| /api/user/ | SQLi: drop table users | 403 | ✅ | 15ms | 🛡️ Blocked - Forbidden (W... |
| /api/user/ | SQLi: exec sp_configure | 403 | ✅ | 8ms | 🛡️ Blocked - Forbidden (W... |
| /api/user/ | SQLi: 1' OR '1'='1 | 403 | ✅ | 92ms | 🛡️ Blocked - Forbidden (W... |
...
| /api/wallet/ | XSS: onload=alert('xss') | 403 | ✅ | 5ms | 🛡️ Blocked - Forbidden (W... |
...
| /api/wallet/ | XSS: base64_decode | 403 | ✅ | 14ms | 🛡️ Blocked - Forbidden (W... |
...
| /api/user/ | XSS: base64_decode | 403 | ✅ | 16ms | 🛡️ Blocked - Forbidden (W... |
| /api/user/ | XSS: eval(String.fromCharCode | 403 | ✅ | 3ms | 🛡️ Blocked - Forbidden (W... |
| /api/user/ | XSS: document.cookie | 403 | ✅ | 4ms | 🛡️ Blocked - Forbidden (W... |
| /api/user/ | Path: ..\..\..\windows\system.ini | 404 | ✅ | 6ms | 🛡️ Blocked - Not found (l... |
...
| /api/auth/login | Rate Limit Test | 403 | ✅ | 17ms | 🛡️ Blocked - Forbidden (m... |
| /api/auth/login | Rate Limit Test | 403 | ✅ | 10ms | 🛡️ Blocked - Forbidden (m... |
| /api/auth/login | Rate Limit Test | 403 | ✅ | 10ms | 🛡️ Blocked - Forbidden (m... |
| /api/auth/login | Rate Limit Test | 403 | ✅ | 9ms | 🛡️ Blocked - Forbidden (m... |
| /api/auth/login | Rate Limit Test | 403 | ✅ | 9ms | 🛡️ Blocked - Forbidden (m... |
...
| /api/wallet/balance | Rate Limit Test | 403 | ✅ | 28ms | 🛡️ Blocked - Forbidden (m... |
| /api/wallet/balance | Rate Limit Test | 403 | ✅ | 20ms | 🛡️ Blocked - Forbidden (m... |
...
| /api/wallet/balance | Rate Limit Test | 403 | ✅ | 4ms | 🛡️ Blocked - Forbidden (m... |
| /api/wallet/balance | Rate Limit Test | 403 | ✅ | 8ms | 🛡️ Blocked - Forbidden (m... |
...
| /api/wallet/balance | Rate Limit Test | 403 | ✅ | 3ms | 🛡️ Blocked - Forbidden (m... |
| /api/wallet/balance | Rate Limit Test | 403 | ✅ | 3ms | 🛡️ Blocked - Forbidden (m... |
| /api/wallet/balance | Rate Limit Test | 403 | ✅ | 2ms | 🛡️ Blocked - Forbidden (m... |
| /api/wallet/balance | Rate Limit Test | 403 | ✅ | 3ms | 🛡️ Blocked - Forbidden (m... |
| /api/wallet/balance | Rate Limit Test | 403 | ✅ | 3ms | 🛡️ Blocked - Forbidden (m... |
| /api/wallet/balance | Rate Limit Test | 403 | ✅ | 3ms | 🛡️ Blocked - Forbidden (m... |
| /api/wallet/balance | Rate Limit Test | 403 | ✅ | 3ms | 🛡️ Blocked - Forbidden (m... |
...
| /api/deposit/ | Rate Limit Test | 429 | ✅ | 10ms | ⏱️ Rate Limited - Too many... |
| /api/deposit/ | Rate Limit Test | 429 | ✅ | 15ms | ⏱️ Rate Limited - Too many... |
...
| /api/deposit/ | Rate Limit Test | 429 | ✅ | 8ms | ⏱️ Rate Limited - Too many... |
| /api/deposit/ | Rate Limit Test | 429 | ✅ | 9ms | ⏱️ Rate Limited - Too many... |
| /api/deposit/ | Rate Limit Test | 429 | ✅ | 22ms | ⏱️ Rate Limited - Too many... |
| /api/deposit/ | Rate Limit Test | 429 | ✅ | 8ms | ⏱️ Rate Limited - Too many... |
| /api/deposit/ | Rate Limit Test | 429 | ✅ | 7ms | ⏱️ Rate Limited - Too many... |
| /api/deposit/ | Rate Limit Test | 429 | ✅ | 8ms | ⏱️ Rate Limited - Too many... |
| /api/deposit/ | Rate Limit Test | 429 | ✅ | 8ms | ⏱️ Rate Limited - Too many... |
...
| /api/wallet/balance | Invalid JWT: Empty | 403 | ✅ | 3ms | 🛡️ Blocked - Forbidden (W... |
| /api/wallet/balance | Invalid JWT: Invalid | 403 | ✅ | 3ms | 🛡️ Blocked - Forbidden (W... |
