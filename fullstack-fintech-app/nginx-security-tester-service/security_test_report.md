...
| /api/wallet/ | SQLi: delete from users where 1=1 | 403 | ✅ | 9ms | 🛡️ Blocked - Forbidden (W... |
| /api/wallet/ | SQLi: drop table users | 403 | ✅ | 10ms | 🛡️ Blocked - Forbidden (W... |
| /api/wallet/ | SQLi: exec sp_configure | 403 | ✅ | 10ms | 🛡️ Blocked - Forbidden (W... |
| /api/wallet/ | SQLi: 1' OR '1'='1 | 403 | ✅ | 73ms | 🛡️ Blocked - Forbidden (W... |
| /api/wallet/ | SQLi: admin'-- | 403 | ✅ | 9ms | 🛡️ Blocked - Forbidden (W... |
| /api/wallet/ | SQLi: 1' UNION SELECT NULL,NULL-- | 403 | ✅ | 9ms | 🛡️ Blocked - Forbidden (W... |
| /api/deposit/ | SQLi: union select 1,2,3 | 404 | ✅ | 176ms | 🛡️ Blocked - Resource not... |
| /api/deposit/ | SQLi: insert into users values('admin','password') | 404 | ✅ | 28ms | 🛡️ Blocked - Resource not... |
| /api/deposit/ | SQLi: delete from users where 1=1 | 404 | ✅ | 37ms | 🛡️ Blocked - Resource not... |
| /api/deposit/ | SQLi: drop table users | 404 | ✅ | 42ms | 🛡️ Blocked - Resource not... |
| /api/deposit/ | SQLi: exec sp_configure | 404 | ✅ | 38ms | 🛡️ Blocked - Resource not... |
| /api/deposit/ | SQLi: 1' OR '1'='1 | 404 | ✅ | 27ms | 🛡️ Blocked - Resource not... |
| /api/deposit/ | SQLi: admin'-- | 404 | ✅ | 30ms | 🛡️ Blocked - Resource not... |
| /api/deposit/ | SQLi: 1' UNION SELECT NULL,NULL-- | 429 | ✅ | 10ms | ⏱️ Rate Limited - Too many... |
| /api/withdrawals/ | SQLi: union select 1,2,3 | 403 | ✅ | 10ms | 🛡️ Blocked - Forbidden (W... |
| /api/withdrawals/ | SQLi: insert into users values('admin','password') | 403 | ✅ | 10ms | 🛡️ Blocked - Forbidden (W... |
| /api/withdrawals/ | SQLi: delete from users where 1=1 | 403 | ✅ | 8ms | 🛡️ Blocked - Forbidden (W... |
| /api/withdrawals/ | SQLi: drop table users | 401 | ✅ | 69ms | 🛡️ Blocked - Authenticati... |
| /api/withdrawals/ | SQLi: exec sp_configure | 429 | ✅ | 10ms | ⏱️ Rate Limited - Too many... |
| /api/withdrawals/ | SQLi: 1' OR '1'='1 | 429 | ✅ | 10ms | ⏱️ Rate Limited - Too many... |
| /api/withdrawals/ | SQLi: admin'-- | 401 | ✅ | 21ms | 🛡️ Blocked - Authenticati... |
| /api/withdrawals/ | SQLi: 1' UNION SELECT NULL,NULL-- | 403 | ✅ | 10ms | 🛡️ Blocked - Forbidden (W... |
| /api/user/ | SQLi: union select 1,2,3 | 403 | ✅ | 9ms | 🛡️ Blocked - Forbidden (W... |
...
| /api/user/ | SQLi: drop table users | 403 | ✅ | 10ms | 🛡️ Blocked - Forbidden (W... |
| /api/user/ | SQLi: exec sp_configure | 403 | ✅ | 12ms | 🛡️ Blocked - Forbidden (W... |
| /api/user/ | SQLi: 1' OR '1'='1 | 401 | ✅ | 38ms | 🛡️ Blocked - Authenticati... |
...
| /api/wallet/ | XSS: <iframe src=javascript:alert('xss')> | 403 | ✅ | 7ms | 🛡️ Blocked - Forbidden (W... |
...
| /api/wallet/ | XSS: document.cookie | 403 | ✅ | 5ms | 🛡️ Blocked - Forbidden (W... |
| /api/deposit/ | XSS: <script>alert('xss')</script> | 403 | ✅ | 5ms | 🛡️ Blocked - Forbidden (W... |
| /api/deposit/ | XSS: javascript:alert('xss') | 403 | ✅ | 4ms | 🛡️ Blocked - Forbidden (W... |
...
| /api/deposit/ | XSS: base64_decode | 403 | ✅ | 10ms | 🛡️ Blocked - Forbidden (W... |
...
| /api/user/ | Path: .git/config | 403 | ✅ | 4ms | 🛡️ Blocked - Forbidden (W... |
| /api/user/ | Path: .env | 403 | ✅ | 5ms | 🛡️ Blocked - Forbidden (W... |
...
| /api/wallet/balance | Rate Limit Test | 429 | ✅ | 8ms | ⏱️ Rate Limited - Too many... |
| /api/wallet/balance | Rate Limit Test | 429 | ✅ | 29ms | ⏱️ Rate Limited - Too many... |
| /api/wallet/balance | Rate Limit Test | 429 | ✅ | 12ms | ⏱️ Rate Limited - Too many... |
...
| /api/deposit/ | Rate Limit Test | 429 | ✅ | 9ms | ⏱️ Rate Limited - Too many... |
| /api/deposit/ | Rate Limit Test | 429 | ✅ | 18ms | ⏱️ Rate Limited - Too many... |
| /api/deposit/ | Rate Limit Test | 429 | ✅ | 17ms | ⏱️ Rate Limited - Too many... |
| /api/deposit/ | Rate Limit Test | 429 | ✅ | 14ms | ⏱️ Rate Limited - Too many... |
| /api/deposit/ | Rate Limit Test | 429 | ✅ | 10ms | ⏱️ Rate Limited - Too many... |
| /api/deposit/ | Rate Limit Test | 429 | ✅ | 10ms | ⏱️ Rate Limited - Too many... |
| /api/deposit/ | Rate Limit Test | 429 | ✅ | 10ms | ⏱️ Rate Limited - Too many... |
| /api/deposit/ | Rate Limit Test | 429 | ✅ | 9ms | ⏱️ Rate Limited - Too many... |
...
| /api/deposit/ | Rate Limit Test | 429 | ✅ | 8ms | ⏱️ Rate Limited - Too many... |
| /api/deposit/ | Rate Limit Test | 429 | ✅ | 10ms | ⏱️ Rate Limited - Too many... |
| /api/deposit/ | Rate Limit Test | 429 | ✅ | 23ms | ⏱️ Rate Limited - Too many... |
| /api/deposit/ | Rate Limit Test | 429 | ✅ | 9ms | ⏱️ Rate Limited - Too many... |
| /api/deposit/ | Rate Limit Test | 429 | ✅ | 8ms | ⏱️ Rate Limited - Too many... |
| / | Bot UA: Suspicious | 404 | ✅ | 7ms | 🛡️ Blocked - Resource not... |
| / | Bot UA: Suspicious | 404 | ✅ | 3ms | 🛡️ Blocked - Resource not... |
| / | Bot UA: Suspicious | 404 | ✅ | 5ms | 🛡️ Blocked - Resource not... |
| / | Bot UA: Suspicious | 404 | ✅ | 3ms | 🛡️ Blocked - Resource not... |
...
| /api/wallet/balance | Invalid JWT: Invalid | 401 | ✅ | 24ms | 🛡️ Blocked - Authenticati... |
| /api/wallet/balance | Invalid JWT: Invalid | 403 | ✅ | 18ms | 🛡️ Blocked - Forbidden (W... |
| /api/wallet/balance | Invalid JWT: Empty | 403 | ✅ | 18ms | 🛡️ Blocked - Forbidden (W... |
| /api/wallet/balance | Invalid JWT: Invalid | 403 | ✅ | 17ms | 🛡️ Blocked - Forbidden (W... |
...
⚠️ **Rate Limiting Used as Security Control**: Some SQLi/XSS attacks are returning 429 (rate limited) instead of 403/400 (security blocked). Attackers could bypass this by sending attacks slowly.
  ...
  - SQLi: exec sp_configure on /api/withdrawals/ - Rate limited instead of security blocked
