...
import pesco.example.authentication_service.responses.CacheResponse;
import pesco.example.authentication_service.servicesImplementation.UserCacheService;
...
public class UserCacheController {
   ...
   @GetMapping("/all")
     ...
     */
    @GetMapping("/stats")
    public ResponseEntity<CacheResponse<UserCacheService.CacheStats>> getCacheStats() {
        try {
            UserCacheService.CacheStats stats = userCacheService.getCacheStats();
            CacheResponse<UserCacheService.CacheStats> response = new CacheResponse<>(
                true, 
                null, 
                stats, 
                true, 
