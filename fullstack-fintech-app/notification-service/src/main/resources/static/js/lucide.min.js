...
(function(a, i) {
    ...
    const i = {
      ...
      , Au = t => Array.from(t.attributes).reduce( (h, d) => (h[d.name] = d.value,
    h), {})
      , Vu = t => typeof t == "string" ? t : !t || !t.class ? "" : t.class && typeof t.class == "string" ? t.class.split(" ") : t.class && Array.isArray(t.class) ? t.class : ""
      , Su = t => t.flatMap(Vu).map(h => h.trim()).filter(Boolean).filter( (h, d, c) => c.indexOf(h) === d).join(" ")
      , Lu = t => t.replace(/(\w)(\w*)(_|-|\s*)/g, (h, d, c) => d.toUpperCase() + c.toLowerCase())
      , da = (t, {nameAttr: h, icons: d, attrs: c}) => {
        ...
        const Cu = Au(t)
          ...
          , wu = Su(["lucide", `lucide-${M}`, Cu, c]);
        wu && Object.assign(Hu, {
            class: wu
        });
        const ku = ha(uu, Hu);
        return t.parentNode?.replaceChild(ku, t)
    }
      , ca = [["path", {
        d: "M3.5 13h6"
    }], ["path", {
    ...
    var gu = Object.freeze({
        ...
        GitMerge: UM,
        GitPullRequest: EM,
        GitPullRequestArrow: ZM,
        GitPullRequestClosed: OM,
        GitPullRequestCreate: IM,
        GitPullRequestCreateArrow: GM,
        ...
        MessageCircleOff: Dn,
        MessageCirclePlus: Fn,
        MessageCircleQuestion: r2,
        MessageCircleQuestionMark: r2,
        MessageCircleReply: zn,
        MessageCircleWarning: bn,
        MessageCircleX: Rn,
        MessageSquare: _n,
        MessageSquareCode: Tn,
        MessageSquareDashed: Un,
        MessageSquareDiff: Zn,
        MessageSquareDot: Gn,
        MessageSquareHeart: On,
        MessageSquareLock: In,
        MessageSquareMore: Wn,
        MessageSquareOff: En,
        MessageSquarePlus: Xn,
        MessageSquareQuote: jn,
        MessageSquareReply: Nn,
        MessageSquareShare: Kn,
        MessageSquareText: Qn,
        MessageSquareWarning: Jn,
        MessageSquareX: Yn,
        MessagesSquare: xn,
        Mic: tl,
        Mic2: o2,
        ...
        ReceiptCent: vo,
        ReceiptEuro: yo,
        ReceiptIndianRupee: $o,
        ReceiptJapaneseYen: mo,
        ReceiptPoundSterling: so,
        ReceiptRussianRuble: go,
        ReceiptSwissFranc: uo,
        ReceiptText: Co,
        ReceiptTurkishLira: Ho,
        RectangleCircle: Ao,
        RectangleEllipsis: P2,
        RectangleGoggles: Vo,
        RectangleHorizontal: Lo,
        RectangleVertical: So,
        Recycle: fo,
        Redo: Bo,
        Redo2: ko,
        RedoDot: Po,
        ...
        SendHorizontal: b2,
        SendToBack: Iv,
        SeparatorHorizontal: Ev,
        SeparatorVertical: Xv,
        Server: Qv,
        ServerCog: jv,
        ServerCrash: Nv,
        ServerOff: Kv,
    ...
    const fu = ({icons: t=gu, nameAttr: h="data-lucide", attrs: d={}}={}) => {
...
lucide.createIcons({icons});\``);
    ...
    a.ChartBarIncreasing = rd,
    a.ChartBarStacked = od,
    ...
    a.Copyright = L6,
    a.CornerDownLeft = k6,
    a.CornerDownRight = P6,
    a.CornerLeftDown = B6,
    a.CornerLeftUp = F6,
    a.CornerRightDown = D6,
    a.CornerRightUp = z6,
    a.CornerUpLeft = b6,
    a.CornerUpRight = R6,
    a.Cpu = q6,
    a.CreativeCommons = T6,
    a.CreditCard = U6,
    a.Croissant = O6,
    a.Crop = Z6,
    a.Cross = G6,
    ...
    a.FileChartColumnIncreasing = D1,
    a.FileChartLine = b1,
    a.FileChartPie = R1,
    a.FileCheck = Cc,
    a.FileCheck2 = uc,
    ...
    a.FilePlus2 = Oc,
    a.FileQuestion = O1,
    a.FileQuestionMark = O1,
    a.FileScan = Ic,
    a.FileSearch = Ec,
    a.FileSearch2 = Wc,
    a.FileSignature = T1,
    a.FileSliders = Xc,
    a.FileSpreadsheet = jc,
    a.FileStack = Nc,
    a.FileSymlink = Kc,
    a.FileTerminal = Qc,
    a.FileText = Jc,
    ...
    a.FilterX = E1,
    a.Fingerprint = l7,
    a.FireExtinguisher = e7,
    a.Fish = o7,
    a.FishOff = r7,
    a.FishSymbol = v7,
    a.Flag = s7,
    a.FlagOff = y7,
    a.FlagTriangleLeft = $7,
    a.FlagTriangleRight = m7,
    a.Flame = u7,
    a.FlameKindling = g7,
    a.Flashlight = H7,
    a.FlashlightOff = C7,
    ...
    a.GitCommitVertical = zM,
    a.GitCompare = RM,
    a.GitCompareArrows = bM,
    a.GitFork = qM,
    a.GitGraph = TM,
    a.GitMerge = UM,
    a.GitPullRequest = EM,
    a.GitPullRequestArrow = ZM,
    a.GitPullRequestClosed = OM,
    a.GitPullRequestCreate = IM,
    a.GitPullRequestCreateArrow = GM,
    ...
    a.Handshake = s9,
    a.HardDrive = C9,
    a.HardDriveDownload = g9,
    a.HardDriveUpload = u9,
    a.HardHat = H9,
    a.Hash = w9,
    a.HatGlasses = A9,
    a.Haze = V9,
    ...
    a.Layers3 = M2,
    a.Layout = S2,
    a.LayoutDashboard = Kp,
    a.LayoutGrid = jp,
    a.LayoutList = Np,
    a.LayoutPanelLeft = Qp,
    a.LayoutPanelTop = Jp,
    a.LayoutTemplate = Yp,
    a.Leaf = _p,
    a.LeafyGreen = xp,
    ...
    a.MessageCirclePlus = Fn,
    a.MessageCircleQuestion = r2,
    a.MessageCircleQuestionMark = r2,
    a.MessageCircleReply = zn,
    a.MessageCircleWarning = bn,
    a.MessageCircleX = Rn,
    a.MessageSquare = _n,
    a.MessageSquareCode = Tn,
    a.MessageSquareDashed = Un,
    a.MessageSquareDiff = Zn,
    a.MessageSquareDot = Gn,
    a.MessageSquareHeart = On,
    a.MessageSquareLock = In,
    a.MessageSquareMore = Wn,
    a.MessageSquareOff = En,
    a.MessageSquarePlus = Xn,
    a.MessageSquareQuote = jn,
    a.MessageSquareReply = Nn,
    a.MessageSquareShare = Kn,
    a.MessageSquareText = Qn,
    a.MessageSquareWarning = Jn,
    a.MessageSquareX = Yn,
    a.MessagesSquare = xn,
    a.Mic = tl,
    a.Mic2 = o2,
    ...
    a.MousePointer = Dl,
    a.MousePointer2 = Pl,
    a.MousePointerBan = Bl,
    a.MousePointerClick = Fl,
    ...
    a.PanelLeftOpen = H2,
    a.PanelRight = Ue,
    a.PanelRightClose = Re,
    a.PanelRightDashed = A2,
    a.PanelRightInactive = A2,
    a.PanelRightOpen = qe,
    a.PanelTop = Oe,
    a.PanelTopClose = Te,
    a.PanelTopDashed = V2,
    ...
    a.PanelTopOpen = Ze,
    a.PanelsLeftBottom = Ge,
    a.PanelsLeftRight = S1,
    a.PanelsRightBottom = Ie,
    a.PanelsTopBottom = F2,
    a.PanelsTopLeft = S2,
    a.Paperclip = We,
    a.Parentheses = Ee,
    a.ParkingCircle = n1,
    ...
    a.ReceiptCent = vo,
    a.ReceiptEuro = yo,
    a.ReceiptIndianRupee = $o,
    a.ReceiptJapaneseYen = mo,
    a.ReceiptPoundSterling = so,
    a.ReceiptRussianRuble = go,
    a.ReceiptSwissFranc = uo,
    a.ReceiptText = Co,
    a.ReceiptTurkishLira = Ho,
    a.RectangleCircle = Ao,
    a.RectangleEllipsis = P2,
    a.RectangleGoggles = Vo,
    a.RectangleHorizontal = Lo,
    a.RectangleVertical = So,
    a.Recycle = fo,
    a.Redo = Bo,
    a.Redo2 = ko,
    a.RedoDot = Po,
    ...
    a.SendHorizontal = b2,
    a.SendToBack = Iv,
    a.SeparatorHorizontal = Ev,
    a.SeparatorVertical = Xv,
    a.Server = Qv,
    a.ServerCog = jv,
    a.ServerCrash = Nv,
    a.ServerOff = Kv,
    ...
    a.Slice = Gy,
    a.Sliders = T2,
    a.SlidersHorizontal = Iy,
    a.SlidersVertical = T2,
    a.Smartphone = Xy,
    a.SmartphoneCharging = Wy,
    a.SmartphoneNfc = Ey,
    a.Smile = Ny,
    a.SmilePlus = jy,
    a.Snail = Ky,
    a.Snowflake = Qy,
    a.SoapDispenserDroplet = Jy,
    a.Sofa = Yy,
    a.SortAsc = C,
    a.SortDesc = s,
    a.Soup = _y,
    ...
    a.Table = rm,
    a.Table2 = cm,
    a.TableCellsMerge = Mm,
    a.TableCellsSplit = pm,
    a.TableColumnsSplit = im,
    a.TableConfig = l,
    a.TableOfContents = nm,
    a.TableProperties = lm,
    a.TableRowsSplit = em,
    a.Tablet = vm,
    a.TabletSmartphone = om,
    a.Tablets = ym,
    a.Tag = $m,
    a.Tags = mm,
    a.Tally1 = sm,
