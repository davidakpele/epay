...
public class CardControl {
    ...
    private Set<String> allowedCountries; // ISO country codes
    ...
    @CollectionTable(name = "card_allowed_merchant_categories", 
                    joinColumns = @JoinColumn(name = "control_id"))
    @Column(name = "mcc")
    private Set<String> allowedMerchantCategories; // MCC codes
    ...
    private Set<String> blockedMerchants; // Specific merchant IDs
    
    // Time-based Controls
    @Column(name = "valid_from_time")
    private LocalTime validFromTime; // Daily usage window start
    
    @Column(name = "valid_to_time")
    private LocalTime validToTime; // Daily usage window end
