...
export default function Default() {
  ...
  const [forgotPinErrors, setForgotPinErrors] = useState<
    ...
    try {
      const payload =
        regMode === "email"
          ...
          : {
              identifier: `${selectedCountry?.code}${resetPasswordData.phone}`,
              method: "PHONE",
            };
  ...
  const handleRequestCode = async () => {
    ...
    try {
      ...
      showToast(
        typeof error === "string"
          ? error
          : error?.message || error?.data?.message || "Failed to send code.",
      );
    } finally {
  ...
  const showForm = (
    form: "login" | "register" | "forgotPin" | "resetPassword",
  ) => {
      ...
      <div className={styles.page}>
        ...
        <section className={styles.hero}>
          ...
          <div className={styles.heroSlides}>
            <div
              className={`${styles.heroSlide} ${styles.heroSlide1} ${currentSlide === 0 ? styles.active : ""}`}
            />
            <div
              className={`${styles.heroSlide} ${styles.heroSlide2} ${currentSlide === 1 ? styles.active : ""}`}
            />
            <div
              className={`${styles.heroSlide} ${styles.heroSlide3} ${currentSlide === 2 ? styles.active : ""}`}
            />
          </div>
          ...
          <div className={styles.heroInner}>
            ...
            <div className={styles.heroCopy}>
              ...
              <p className={styles.heroSub}>
                You&apos;re going to love banking with us. We created accounts
                tailored to suit your individual needs as a valued customer.
              </p>
            </div>

            {/* ── LOGIN FORM ── */}
            {!showRegister &&
              !showForgetUsernameForm &&
              !showOTPForm &&
                ...
                <form onSubmit={handleLoginSubmit} noValidate>
                  <div className={styles.loginCard} id="loginCard">
                    ...
                    <p className={styles.inputHint}>
                      If Corporate, format is Corp ID.User ID
                    </p>
            ...
            {showRegister && (
              <form onSubmit={handleRegisterSubmit} noValidate>
                <div
                  className={`${styles.RegisterCard} ${styles.registerCard}`}
                  id="registerCard"
                >
                  <div className={styles.cardHeader}>
                    <button
                  ...
                  <div className={styles.inputGroup}>
                    <input
                      ...
                      type="text"
                      name="username"
                      className={`${styles.cardInput} ${registerErrors.username ? styles.inputError : ""}`}
                  ...
                  <div className={styles.inputGroup}>
                    <div className={styles.verificationWrapper}>
                      <input
                        ...
                        className={`${styles.formControl} ${registerErrors.verificationCode ? styles.inputError : ""}`}
                        onChange={handleRegisterChange}
                        placeholder="Enter code"
                      />
                      <button
                        type="button"
                        className={styles.btnRequestCode}
              ...
              showOTPForm && (
                <div className={styles.OTPCard}>
                  ...
                  <div className={styles.otpInfo}>
                    <p>
                      Enter the 4-digit code sent to your email/phone to
                      complete login.
                    </p>
                  </div>
                  ...
                  <form
                    onSubmit={(e) => {
                      e.preventDefault();
                      handleOTPSubmitWithCode(code.join(""));
                    }}
                  ...
                  >
                    {filteredCountries.map((c) => (
                      ...
                      >
                        ...
                        <div
                          className={`${styles.radioOuter} ${selectedCountry?.name === c.name ? styles.checked : ""}`}
                        >
            ...
            <div className={styles.bottomCards}>
              <div className={styles.bottomCard}>
                ...
                <div className={styles.bcBody}>
                  <div className={`${styles.bcTitle} ${styles.alert}`}>
                    Security Alert!
                  </div>
                  <p className={styles.bcText}>
                    Avoid sharing your card details, internet banking log in and
                    PIN with anyone.
                  </p>
                  <div className={styles.bcLinks}>
                    <a className={styles.bcLink} href="#">
                      Learn More
                    </a>
              ...
              <div className={styles.bottomCard}>
                ...
                <div className={styles.bcBody}>
                  ...
                  <p className={styles.bcText}>
                    Our Internet Banking Service gives you unrestricted and
              ...
              <div className={styles.bottomCard}>
                ...
                <div className={styles.bcBody}>
                  ...
                  <p className={styles.bcText}>
                    Our CFC is a 24/7 one-stop shop to help you with your
                    requests. +234 700 000 0000
                  </p>
                  <div className={styles.bcLinks}>
                    <a className={styles.bcLink} href="#">
                      Live Chat
