...
export const API_URLS = {
  AUTH: {
    ...
    VERIFYTOKEN: (token: string) =>
      `${SERVICE_URLS.AUTH}/auth/verify-otp-token?token=${token}`,
  ...
  USER: {
    ...
    SENDACCOUNTSTATEMENT: (id: string | number) =>
      `${SERVICE_URLS.USER}/receipt/generate-pdf/${id}`,
    UPDATE2FASTATUS: () => `${SERVICE_URLS.USER}/settings/enable-twofactor`,
    UPLOAD_PROFILE_IMAGE: (id: string | number) =>
      `${SERVICE_URLS.USER}/settings/upload-profile-image/${id}`,
    REMOVE_PROFILE_IMAGE: (id: string | number) =>
      `${SERVICE_URLS.USER}/settings/remove-profile-image/${id}`,
    DELETE_ACCOUNT: (id: string | number) =>
      `${SERVICE_URLS.USER}/settings/delete-account/${id}`,
  },

  ACCOUNTSETTING: {
    BY_ID: (id: string | number) => `${SERVICE_URLS.USER}/settings/user/${id}`,
    UPDATE_NOTIFICATION_SETTINGS: (id: string | number) =>
      `${SERVICE_URLS.USER}/settings/${id}/notifications`,
    UPDATE_SESSION_TIMEOUT: (id: string | number) =>
      `${SERVICE_URLS.USER}/settings/${id}/session-timeout`,
    UPDATE_BIOMETRIC_STATUS: (id: string | number) =>
      `${SERVICE_URLS.USER}/settings/${id}/biometric`,
    UPDATE_PREFERENCES: (id: string | number) =>
      `${SERVICE_URLS.USER}/settings/${id}/preferences`,
  },
  ...
  DEPOSIT: {
    ...
    HISTORY: (userId: string | number) =>
      `${SERVICE_URLS.DEPOSIT}/deposit/history/${userId}`,
    STATUS: (id: string | number) =>
      `${SERVICE_URLS.DEPOSIT}/deposit/${id}/status`,
  },
  ...
  PAYMENT: {
    ...
    STATUS: (id: string | number) =>
      `${SERVICE_URLS.PAYMENT}/payments/${id}/status`,
  },

  WALLET: {
    ID: (id: string | number) => `${SERVICE_URLS.WALLET}/wallet/${id}`,
    BY_USER_ID: (id: string | number) =>
      `${SERVICE_URLS.WALLET}/wallet/userId/${id}`,
    CURRENCY: (id: string | number, currency: string) =>
      `${SERVICE_URLS.WALLET}/wallet/${id}/${currency}`,
    CREATEWITHDRAWPIN: (id: string | number) =>
      `${SERVICE_URLS.WALLET}/wallet/create/${id}/pin`,
    VERIFYPIN: `${SERVICE_URLS.WALLET}/wallet/verify/pin`,
    UPDATE_DEFAULT_CURRENCY: (id: string) =>
      `${SERVICE_URLS.WALLET}/wallet/${id}/default/currency`,
  },

  BANKCOLLECTIONLIST: {
    BASE: `${SERVICE_URLS.BANKCOLLECTIONLIST}/bank`,
    CREATE: `${SERVICE_URLS.BANKCOLLECTIONLIST}/bank`,
    CREATEVIRTUALCARD: `${SERVICE_URLS.BANKCOLLECTIONLIST}/bank/create/virtual-card`,
    GET_BY_ID: (id: string | number) =>
      `${SERVICE_URLS.BANKCOLLECTIONLIST}/bank/details/${id}`,
    GET_BY_ACCOUNT_NUMBER: (accountNumber: string) =>
      `${SERVICE_URLS.BANKCOLLECTIONLIST}/bank/accounts/${accountNumber}`,
    GET_BY_USER_ID: (userId: string | number) =>
      `${SERVICE_URLS.BANKCOLLECTIONLIST}/bank/user/${userId}`,
    DELETE: (id: string | number) =>
      `${SERVICE_URLS.BANKCOLLECTIONLIST}/bank/delete/${id}`,
    GET_BANK_LIST_API: `${SERVICE_URLS.BANKCOLLECTIONLIST}/bank/list`,
    VERIFY_USER_BANK_DETAILS: (accountNumber: string, bankCode: string) =>
      `${SERVICE_URLS.BANKCOLLECTIONLIST}/bank/verify?accountNumber=${accountNumber}&bankCode=${bankCode}`,
    ...
    GET_VIRTUAL_CARD_LIST_BY_USER_ID: (id: string | number) =>
      `${SERVICE_URLS.BANKCOLLECTIONLIST}/bank/${id}/cards`,
  },
  ...
  HISTORY: {
    ALL: (userId: string | number) =>
      `${SERVICE_URLS.HISTORY}/history/user/${userId}`,
    ...
    BENEFICIARY: (beneficiaryId: string | number) =>
      `${SERVICE_URLS.HISTORY}/history/user/${beneficiaryId}`,
  },

  BENEFICIARY: {
    BASE: `${SERVICE_URLS.BENEFICIARY}/beneficiaries`,
    CREATE: `${SERVICE_URLS.BENEFICIARY}/beneficiaries/create`,
    GET_ALL: (userId: string | number) =>
      `${SERVICE_URLS.BENEFICIARY}/beneficiaries/${userId}/all`,
    GET_BY_ID: (id: string | number) =>
      `${SERVICE_URLS.BENEFICIARY}/beneficiaries/${id}`,
    UPDATE: (id: string | number) =>
      `${SERVICE_URLS.BENEFICIARY}/beneficiaries/${id}`,
    DELETE: (id: string | number) =>
      `${SERVICE_URLS.BENEFICIARY}/beneficiaries/${id}`,
    VERIFY: (id: string | number) =>
      `${SERVICE_URLS.BENEFICIARY}/beneficiaries/${id}/verify`,
    CHECK_IF_GOT_USER: (id: string | number, recipientUsername: string) =>
      `${SERVICE_URLS.BENEFICIARY}/beneficiaries/${id}/username/${recipientUsername}`,
  },

  VIRTUALCARD: {
    GET_CARDS_BY_USER_ID: (id: string | number) =>
      `${SERVICE_URLS.VIRTUALCARD}/virtual-cards/user/${id}`,
  ...
  INVESTMENT: {
    ...
    BY_USER_ID: (userId: string | number) =>
      `${BASE_URL}/investments/user/${userId}`,
    BY_ID: (id: string | number, userId: string | number) =>
      `${BASE_URL}/investments/${id}?userId=${userId}`,
  },
