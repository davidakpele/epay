...
const Dashboard = () => {
  ...
  const fetchHistory = useCallback(async () => {
    ...
    // Support new paginated shape: { success, data: { content: [...] } }
  ...
  const fetchUserProfile = async () => {
    try {
      ...
      setSettings((prev) => ({
        ...
        profile: {
          ...
          profileImage: userRecord.photo
            ? `http://localhost:8029/api${userRecord.photo}`
            : "/assets/images/user-profile.jpg",
        },
        security: {
      ...
      if (userRecord.photo) {
        const fullImageUrl = `http://localhost:8029/api${userRecord.photo}`;
  ...
  const quickActions = [
    {
      ...
      label: "Airtime",
      color: "#ff7a5c",
      route: "/services/bills/airtime",
    },
    {
      icon: <Wifi />,
      label: "Data",
      color: "#5ecdbf",
      route: "/services/bills/data",
    },
    {
      icon: <Tv />,
      label: "CableTv",
      color: "#5eb7cd",
      route: "/services/bills/cabletv",
    },
    {
      icon: <Lightbulb />,
      label: "Electricity",
      color: "#ffac7a",
      route: "/services/bills/electricity",
    },
    {
      icon: <CreditCard />,
      label: "Virtual Card",
      ...
      <main className={`main-content ${isDepositOpen ? "dashboard-blur" : ""}`}>
        ...
        <div className="scrollable-content">
          <div className="welcome-message">
            ...
            <span
              className={`user-name-out ${theme === "dark" ? "color-light" : "color-dark"}`}
            >
            ...
            >
              {quickActions.map((action, idx) => (
                ...
                >
                  ...
                  >
                    {React.cloneElement(
                      action.icon as React.ReactElement<LucideProps>,
                      { size: 22 },
                    )}
                  </div>
