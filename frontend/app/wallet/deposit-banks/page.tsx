...
import { CheckCircle, Trash2, Trash2Icon } from "lucide-react";
...
const Banks = () => {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      const result = await bankCollectionService.getUserBanks(
  ...
  const handleAddBank = async () => {
    ...
    try {
      ...
      const payload = {
        ...
        accountHolderName: newBank.accountName,
        userId: getUserId(),
  ...
  const confirmBulkDelete = async () => {
    try {
      ...
      if (allSucceeded) {
        ...
        showToast(
          `${idsToDelete.length} bank account(s) deleted successfully`,
          "success",
        );
      } else {
        showToast(
          "Some accounts could not be deleted. Please try again.",
          "warning",
        );
                ...
                <div className="banks-card">
                  ...
                  {!showForm ? (
                    <button
                      ...
                      className="add-bank-placeholder"
                    >
                    ...
                    <div className="add-bank-form">
                      ...
                      <p className="form-note">
                        <span className="note-bold">NOTE:</span> Accounts added
                        here are solely for deposits and not for withdrawals.
                        Make sure it is your own account and the account name
                        matches
                      </p>
                      ...
                      {!verify ? (
                        ...
                        <div className="verified-bank-display">
                          <div
                            className={`currency1 mb-3 bank-item ${theme === "dark" ? "light-background" : "dark-background"}`}
                          >
                            ...
                            <div className="currency1__main">
                              <span className="currency1__abbr accountHolderName">
                                {newBank.bankName}
                              </span>
                  ...
                  {loading && banks.length === 0 ? (
                    ...
                    <div className="empty-state">
                      ...
                      <p className="empty-subtitle">
                        Add your first bank account using the form
                      </p>
                    </div>
                  ) : (
                        ...
                        <div className="mb-3">
                          {banks.map((bank) => {
                            ...
                            return (
                              ...
                              >
                                <div
                                  className={`currency1 mb-3 bank-item ${theme === "dark" ? "light-background" : "dark-background"} ${isChecked ? "bank-item--selected" : ""}`}
                                >
                                  {/* Checkbox */}
                                  <div
                                    className={`bank-checkbox ${isChecked ? "bank-checkbox--checked" : ""}`}
                                    onClick={(e) =>
                                      handleCheckboxChange(bank.id, e)
                                    }
                                    title="Select"
                                  >
                                    {isChecked && (
            ...
            <div className="modal-overlay">
              <div className="modal success-modal">
                ...
                <p className="modal-text">
                  Your bank account has been added and verified.
                </p>
                <button
          ...
          {showBulkDeleteConfirm && (
            <div className="modal-overlay">
              <div className="modal delete-modal">
                ...
                <h3 className="modal-title" style={{ textAlign: "center" }}>
                  Delete {selectedBanks.size} Bank Account
                  {selectedBanks.size > 1 ? "s" : ""}
                </h3>
                <p className="modal-text">
                  Are you sure you want to delete{" "}
                  {selectedBanks.size > 1 ? "these accounts" : "this account"}?
