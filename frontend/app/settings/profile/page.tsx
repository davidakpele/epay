...
const UserProfile = () => {
  ...
  const [isEditUserProfileDetails, setIsEditUserProfileDetails] =
    useState(false);
  const [isShowSuspendAccountModal, setShowSuspendAccountModal] =
    useState(false);
  ...
  const fetchUserProfile = async () => {
    try {
      ...
      const isNewShape = response?.success === true && response?.data;
      const raw = isNewShape ? response.data : response;
      ...
      const mappedUserData: UserData = {
        ...
        phone: personal.phoneNumber || personal.telephone || "",
        ...
        referralName:
          personal.referralCode || raw?.referralName || raw?.username || "",
        customerId: raw?.customerId || `#${userId}`,
      ...
      setUserProfile({
        ...raw,
        _personal: personal,
        _mappedUserData: mappedUserData,
      });

      setUserData(mappedUserData);

      const isProfileIncomplete =
        (!personal.phoneNumber && !personal.telephone) ||
        !personal.gender ||
      ...
      const firstName = personal.firstName || getUserFirstName() || "";
      const lastName = personal.lastName || getUserLastName() || "";
      setMetaMapData((prev) => ({ ...prev, firstName, lastName }));
    } catch (error) {
  ...
  const handleEditProfile = () => {
    if (!userData) return;
    const personal = userProfile?._personal || {};
    setFormData({
      firstName: personal.firstName || userData.fullName.split(" ")[0] || "",
      lastName:
        personal.lastName ||
      ...
      telephone:
        personal.phoneNumber || personal.telephone || userData.phone || "",
      gender: (personal.gender || userData.gender || "").toLowerCase(),
      dob:
        personal.dateOfBirth ||
        personal.dateofBirth ||
        userData.dateOfBirth ||
        "",
      address: personal.address || userData.address || "",
      country: personal.country || userData.country || "",
      state: personal.state || "",
      city: personal.city || userData.city || "",
    });
  ...
  const handleStateChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    const selected = State.getStatesOfCountry(metaMapData.countryCode).find(
  ...
  const handleMetaMapNext = async () => {
    ...
    if (!metaMapData.telephone.trim()) {
      errors.telephone = "Phone number is required";
    } else if (!/^\+?[0-9\s\-()]{7,20}$/.test(metaMapData.telephone.trim())) {
      errors.telephone =
    ...
    const finalData = {
      ...
      email: userEmail,
      address: "",
      telephone: metaMapData.telephone,
  ...
  const handleMetaMapSelectChange = (
      ...
      >
        ...
        <main className={`main-content`}>
          ...
          <div className="scrollable-content">
            <div
              className={`user-profile-container ${theme == "dark" ? "bg-light" : "bg-dark"}`}
            >
              ...
              <div className="user-profile-header">
                <button
                  className={`user-profile-back-btn ${theme === "dark" ? "color-light" : "color-dark"}`}
                ...
                <div className="user-profile-info-left">
                  ...
                  <div className="user-profile-basic-info">
                    <div className="user-profile-name-row">
                      ...
                      <span
                        className={`user-profile-status-badge ${userData.status.toLowerCase()}`}
                      >
                        {userData.status}
                      </span>
                    ...
                    <p className="user-profile-customer-id">
              ...
              <div className="user-profile-content">
                      ...
                      <>
                        ...
                        <div className="settings-actions">
                          <button
                            ...
                            onClick={() => setIsEditUserProfileDetails(false)}
                          >
                            Cancel
                          </button>
                          <button
                  ...
                  <div className="user-profile-info-section">
                    ...
                    <div className="user-profile-documents-list">
                      {kycDocuments.map((doc) => (
                        <div
                          key={doc.id}
                          className="user-profile-document-item"
                        >
                          ...
                          {loadingDocId === doc.id ? (
                            <>
                              <div
                                className={`setting-notif-loader-container"}`}
                              >
                            ...
                            <>
                              <button
                                className="user-profile-btn-view"
                ...
                <div className="user-profile-sidebar">
                  <div className="user-profile-sidebar-section">
                    <h3 className="user-profile-sidebar-title">
                      Security Actions
                    </h3>
                    <div className="user-profile-security-actions">
                      <button
                        className="user-profile-security-action-btn"
                      ...
                      <button
                        className="user-profile-security-action-btn danger"
                  ...
                  <div className="user-profile-sidebar-section">
                    ...
                    <div className="user-profile-login-history-list">
                      {loginHistory.map((login) => (
                        <div
                          key={login.id}
                          className="user-profile-login-history-item"
                        >
                          <div className="user-profile-login-icon">
                            {login.device.includes("iPhone") ||
                            login.device.includes("App") ? (
                              <Smartphone size={20} />
                            ) : (
                              <Monitor size={20} />
                            )}
                ...
                <>
                  ...
                  <div className="user-profile-modal">
                    <div className="user-profile-modal-content">
                      ...
                      <p>
                        Are you sure you want to request deactivation for this
                        account? This action requires admin approval.
                      </p>
                ...
                <>
                  ...
                  <div className="user-profile-modal">
                    <div className="user-profile-modal-content">
                      ...
                      <p>
                        Are you sure you want to request suspend your account?
                ...
                <>
                  ...
                  <div className="user-profile-modal">
                    <div className="user-profile-modal-content">
                      ...
                      <p>
                        This is another nice step to secure your account, on
                        every time someone tries to login - you receive private
                        clearance code and until you give that to that person
                        only then will he gain access to you account
                      </p>
                      <div className="user-profile-modal-actions">
                        <button
                          className="user-profile-btn-secondary"
                  ...
                  <div className="metamap-modal">
                    <div className="metamap-modal-header">
                      <div className="metamap-logo">
                        {metaMapStep === 2 && (
                          <button
                            className="metamap-back-btn"
                            onClick={() => setMetaMapStep(1)}
                          >
                            ←
                          </button>
                        )}
                      ...
                      <button
                        className="metamap-close-btn"
                        onClick={handleMetaMapClose}
                      >
                        ×
                      </button>
                    </div>
                    ...
                    {showMetaMapExit ? (
                      <div className="metamap-exit-modal">
                        ...
                        <div className="metamap-exit-actions">
                          <button
                            className="metamap-exit-btn"
                            onClick={handleMetaMapExit}
                          >
                            Exit
                          </button>
                          <button
                            className="metamap-continue-btn"
                            onClick={handleMetaMapContinue}
                          >
                      ...
                      <>
                        ...
                        {metaMapStep === 1 && (
                          <div className="metamap-step">
                            <h2 className="metamap-title">
                              Let's verify your identity
                            </h2>
                            <p className="metamap-subtitle">
                            ...
                            <div className="metamap-terms">
                              <p>
                                By clicking "Agree and Continue" I consent to
                                Company and its service provider, MetaMap,
                                obtaining and disclosing a scan of my face
                                geometry and barcode of my ID for the purpose of
                                verifying my identity pursuant to Company and
                                MetaMap's Privacy Policies and for improving and
                                updating MetaMap products or services (including
                                its algorithm). Company and MetaMap shall store
                                the biometric data for no longer than 3 years
                                (or as determined by your local regulation).
                              </p>
                              <p>
                                I can exercise my privacy rights, including
                                withdrawal of my consent, by contacting
                                privacy@metamap.com.
                              </p>

                              <p>
                                I have read and agreed to MetaMap{" "}
                                <a href="#">Privacy Policy</a>.
                              </p>
                            </div>

                            <button
                              className="metamap-btn-primary"
                              onClick={handleMetaMapAgree}
                            >
                              Agree and Continue
                            </button>
                          </div>
                            ...
                            <div className="metamap-form">
                              ...
                              <div className="metamap-form-group">
                                ...
                                <input
                                  ...
                                  value={metaMapData.telephone}
                                  onChange={handleMetaMapChange}
                                  className={
                                    metaMapErrors.telephone ? "error" : ""
                                  }
                                />
                                {metaMapErrors.telephone && (
                                  <span className="kyc-error-message">
                                    {metaMapErrors.telephone}
                                  </span>
                                )}
                              ...
                              <div className="metamap-form-group">
                                ...
                                <select
                                  name="state"
                                  value={metaMapData.stateCode}
                                  onChange={handleStateChange}
                                  disabled={!metaMapData.countryCode}
                                >
                                  <option value="">-- Select State --</option>
                                  {State.getStatesOfCountry(
                                    metaMapData.countryCode,
                                  ).map((s) => (
