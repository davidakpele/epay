...
import { getNotificationContainer, getUserFullName } from "@/app/api/utils";
...
const Header = ({ theme, toggleTheme }: HeaderProps) => {
      ...
      items: [
        {
          ...
          submenu: [
            ...
            { label: "My Investments", href: "/investments/portfolio" },
          ],
        },
      ],
    },
  ...
  return (
    <>
      <header
        className={`header sticky-header ${isMobile ? "mobile-header" : ""}`}
      >
        ...
        <div className="header-right">
          ...
          >
            ...
            <span className="header-username">
              {getUserFullName?.()?.split(" ")[0] || "User"}
              <ChevronDown
                size={14}
                className={`dropdown-chevron ${showAccountDropdown ? "rotate" : ""}`}
              />
            </span>
                  ...
                  <div className="notif-filter">
                    ...
                    >
                      ...
                      <option value="messages">
                        Messages ({getFilterCount("messages")})
                      </option>
                      <option value="payments">
                        Payments ({getFilterCount("payments")})
                      </option>
                      <option value="system">
      ...
      {isMobile && isSidebarOpen && (
        <>
          ...
          />
          <div
            className={`mobile-sidebar ${theme === "dark" ? "dark-sidebar" : ""}`}
            ref={sidebarRef}
          >
